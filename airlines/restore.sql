...
\.
COPY public.codes_cancellation (cancellation_code, cancel_desc) FROM '/Users/ulisesvargas/Downloads/combining-filtering-data-postgresql/airlines/3136.dat';
...
\.
COPY public.codes_carrier (carrier_code, carrier_desc) FROM '/Users/ulisesvargas/Downloads/combining-filtering-data-postgresql/airlines/3137.dat';
...
\.
COPY public.perform_feb (fl_date, mkt_carrier, mkt_carrier_fl_num, origin, origin_city_name, origin_state_abr, dest, dest_city_name, dest_state_abr, dep_delay_new, arr_delay_new, cancelled, cancellation_code, diverted, carrier_delay, weather_delay, nas_delay, security_delay, late_aircraft_delay) FROM '/Users/ulisesvargas/Downloads/combining-filtering-data-postgresql/airlines/3138.dat';
...
\.
COPY public.performance (fl_date, mkt_carrier, mkt_carrier_fl_num, origin, origin_city_name, origin_state_abr, dest, dest_city_name, dest_state_abr, dep_delay_new, arr_delay_new, cancelled, cancellation_code, diverted, carrier_delay, weather_delay, nas_delay, security_delay, late_aircraft_delay) FROM '/Users/ulisesvargas/Downloads/combining-filtering-data-postgresql/airlines/3135.dat';
